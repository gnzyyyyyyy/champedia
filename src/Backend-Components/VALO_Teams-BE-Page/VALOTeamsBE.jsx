...
const VALOTeamsBE = ({theme}) => {
    ...
    const handleAddTeam = () => {
        axios
            .post("http://localhost:8080/valo_teams", newTeam)
            .then(() => {
                setShowForm(false);
                resetForm();
    ...
    const handleUpdateTeam = () => {
        axios
            .put(`http://localhost:8080/valo_teams/${editTeamID}`, newTeam)
            .then(() => {
                setShowForm(false);
                resetForm();
                window.location.reload();
    ...
    const confirmRemove = () => {
        axios
            .delete(`http://localhost:8080/valo_teams/${teamToDelete}`)
            .then(() => {
    ...
    const handleRegionSelect = (region) => {
        ...
        axios.get(`http://localhost:8080/valo_teams/region/${region}`)
            .then((response) => {
