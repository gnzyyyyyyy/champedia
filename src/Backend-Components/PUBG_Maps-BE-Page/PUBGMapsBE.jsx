...
const PUBGMapsBE = ({ theme }) => {
    ...
    const handleAddMap = () => {
        axios.post("http://localhost:8080/pubg_maps", newMap)
            .then(() => {
                setShowForm(false);
                resetForm();
    ...
    const handleUpdateMap = () => {
        axios.put(`http://localhost:8080/pubg_maps/${editMapID}`, newMap)
            .then(() => {
                setShowForm(false);
                resetForm();
                window.location.reload();
    ...
    const confirmRemove = () => {
        axios.delete(`http://localhost:8080/pubg_maps/${mapToDelete}`)
            .then(() => {
    ...
    return (
        <div className={`maps-page ${theme}`}>
            ...
            <header className="header">
                <img src={valoBanner} alt="pubgrant" className="header-logo" />
