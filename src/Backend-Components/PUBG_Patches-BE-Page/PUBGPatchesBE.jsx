...
const PUBGPatchesBE = () => {
  ...
  const handleAddPatch = () => {
    axios
      .post("http://localhost:8080/pubg_patches", newPatch)
      .then(() => {
        setShowForm(false);
        resetForm();
  ...
  const handleUpdatePatch = () => {
    axios
      .put(`http://localhost:8080/pubg_patches/${editPatchID}`, newPatch)
      .then(() => {
        setShowForm(false);
        resetForm();
        window.location.reload();
  ...
  const confirmRemove = () => {
    axios
      .delete(`http://localhost:8080/pubg_patches/${patchToDelete}`)
      .then(() => {
  ...
  return (
    <div className="patches-page">
      ...
      <div className="header">
        <img src={mlbbBanner} alt="pubg Banner" className="header-logo" />
