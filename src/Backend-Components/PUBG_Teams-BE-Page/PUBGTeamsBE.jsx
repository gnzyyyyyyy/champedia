...
const PUBGTeamsBE = ({theme}) => {
    ...
    useEffect(() => {
        axios
            .get("http://localhost:8080/pubg_teams")
    ...
    const handleAddTeam = () => {
        axios
            .post("http://localhost:8080/pubg_teams", newTeam)
            .then(() => {
                setShowForm(false);
                resetForm();
    ...
    const handleUpdateTeam = () => {
        axios
            .put(`http://localhost:8080/pubg_teams/${editTeamID}`, newTeam)
            .then(() => {
                setShowForm(false);
                resetForm();
                window.location.reload();
    ...
    const confirmRemove = () => {
        axios
            .delete(`http://localhost:8080/pubg_teams/${teamToDelete}`)
            .then(() => {
    ...
    const handleRegionSelect = (region) => {
        ...
        axios.get(`http://localhost:8080/pubg_teams/region/${region}`)
            .then((response) => {
