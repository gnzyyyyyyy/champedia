...
@Document(collection = "valo_players")
public class VALO_Players_Model {
    ...
    public VALO_Players_Model() {
    }

    public VALO_Players_Model(String id, String playerIGN, String playerName, String playerRole, String playerRegion, String playerCountry, String teamID) {
        this.id = id;
