...
@Document(collection = "mlbb_patches")
public class MLBB_Patches_Model {
    ...
    public MLBB_Patches_Model() {
    }
    public MLBB_Patches_Model(String id, String patchVersion, String patchDate, String patchHighlights) {
        this.id = id;
