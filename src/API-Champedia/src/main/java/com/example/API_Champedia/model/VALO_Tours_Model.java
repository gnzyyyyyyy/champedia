...
@Document(collection = "valo_tours")
public class VALO_Tours_Model {
    ...
    public VALO_Tours_Model() {
    }

    public VALO_Tours_Model(String id, String tourLogo, String tourName, String tourTier, String tourRegion, String tourLocation, String tourDates, String tourPrizePool) {
        this.id = id;
