...
@Document(collection = "cr_tours")
public class CR_Tours_Model {
    ...
    public CR_Tours_Model() {
    }

    public CR_Tours_Model(String id, String tourLogo, String tourName, String tourTier, String tourRegion, String tourLocation, String tourDates, String tourPrizePool) {
        this.id = id;
