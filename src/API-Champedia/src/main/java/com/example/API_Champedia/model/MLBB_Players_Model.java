...
@Document(collection = "mlbb_players")
public class MLBB_Players_Model {
    ...
    public MLBB_Players_Model() {
    }

    public MLBB_Players_Model(String id, String playerIGN, String playerName, String playerRole, String playerRegion, String playerCountry, String teamID) {
        this.id = id;
