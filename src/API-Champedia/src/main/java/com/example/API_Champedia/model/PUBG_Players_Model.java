...
@Document(collection = "pubg_players")
public class PUBG_Players_Model {
    ...
    public PUBG_Players_Model() {
    }

    public PUBG_Players_Model(String id, String playerIGN, String playerName, String playerRole, String playerRegion, String playerCountry, String teamID) {
        this.id = id;
