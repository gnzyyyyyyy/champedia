...
@Document(collection = "mlbb_tours")
public class MLBB_Tours_Model {
    ...
    public MLBB_Tours_Model() {
    }

    public MLBB_Tours_Model(String id, String tourLogo, String tourName, String tourTier, String tourRegion, String tourLocation, String tourDates, String tourPrizePool) {
        this.id = id;
