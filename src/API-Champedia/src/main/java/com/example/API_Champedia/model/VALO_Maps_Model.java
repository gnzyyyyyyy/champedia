...
@Document(collection = "valo_maps")
public class VALO_Maps_Model {
    ...
    public VALO_Maps_Model() {
    }
    public VALO_Maps_Model(String id, String mapName, String mapImages, String mapLayout) {
        this.id = id;
