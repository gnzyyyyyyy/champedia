...
const VALOPlayers = ({ theme }) => {
  ...
  useEffect(() => {
    if (selectedRegion === "All") {
      axios
        .get("http://localhost:8080/valo_players")
        .then((res) => {
      ...
      axios
        .get(`http://localhost:8080/valo_players/region/${selectedRegion}`)
        .then((res) => {
          const sorted = [...res.data].sort((a,b) => a.playerCountry.localeCompare(b.playerCountry));
          setPlayersData(sorted);
        });
